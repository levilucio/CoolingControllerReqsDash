...
public final class ProjectIsCreatedProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xecea2a9218f4e3bL, 0xbadca524a5addb7cL, 0x7766bbf6402d4599L, "org.iets3.process.modelproperty.structure.ProjectIsCreatedProperty");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    ProjectIsCreatedPropertyClass checker = new ProjectIsCreatedPropertyClass();
    if (ListSequence.fromList(checker.checkModel(model, null)).isEmpty()) {
      System.out.println("EmptyProjectProperty: True");
      return true;
    }
    System.out.println("EmptyProjectProperty: False");
    return false;
  }

  /*package*/ ProjectIsCreatedProperty__BehaviorDescriptor() {
    super(REGISTRY);
  }
