...
public final class EmptyRequirementProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xecea2a9218f4e3bL, 0xbadca524a5addb7cL, 0x20fc30679cdcb32eL, "org.iets3.process.modelproperty.structure.EmptyRequirementProperty");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    EmptyRequirementPropertyClass checker = new EmptyRequirementPropertyClass();
    if (ListSequence.fromList(checker.checkModel(model, null)).isEmpty()) {
      System.out.println("EmptyRequirementProperty: True");
      return true;
    }
    System.out.println("EmptyRequirementProperty: False");
    return false;
  }

  /*package*/ EmptyRequirementProperty__BehaviorDescriptor() {
    super(REGISTRY);
  }
