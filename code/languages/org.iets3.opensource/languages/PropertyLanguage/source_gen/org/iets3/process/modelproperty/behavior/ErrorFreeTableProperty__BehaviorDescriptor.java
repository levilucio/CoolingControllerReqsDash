...
public final class ErrorFreeTableProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xecea2a9218f4e3bL, 0xbadca524a5addb7cL, 0x7766bbf64033bf40L, "org.iets3.process.modelproperty.structure.ErrorFreeTableProperty");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    ErrorFreeTablePropertyClass checker = new ErrorFreeTablePropertyClass();
    if (ListSequence.fromList(checker.checkModel(model, null)).isEmpty()) {
      System.out.println("ErrorFreeTableProperty: True");
      return true;
    }
    System.out.println("ErrorFreeTableProperty: False");
    return false;
  }

  /*package*/ ErrorFreeTableProperty__BehaviorDescriptor() {
    super(REGISTRY);
  }
