...
public final class RequirementsChunkNotPresentProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xecea2a9218f4e3bL, 0xbadca524a5addb7cL, 0x3236b854d3d92640L, "org.iets3.flow.property.structure.RequirementsChunkNotPresentProperty");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    RequirementsChunkNotPresentPropertyClass modelChecker = new RequirementsChunkNotPresentPropertyClass();
    if (ListSequence.fromList(modelChecker.checkModel(model, null)).isEmpty()) {
      System.out.println("RequirementsChunkNotPresentProperty: True");
      return true;
    }
    System.out.println("RequirementsChunkNotPresentProperty: False");
    return false;
  }

  /*package*/ RequirementsChunkNotPresentProperty__BehaviorDescriptor() {
    super(REGISTRY);
  }
