...
public final class RequirementsErrorFreeProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xecea2a9218f4e3bL, 0xbadca524a5addb7cL, 0x20fc30679cdcc80cL, "org.iets3.process.modelproperty.structure.RequirementsErrorFreeProperty");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    ...
    RequirementsErrorFreeClass reqErrorFree = new RequirementsErrorFreeClass();
    List<SearchResult<ModelCheckerIssue>> checkModel = reqErrorFree.checkModel(model, null);
    if (ListSequence.fromList(checkModel).isEmpty()) {
      System.out.println("RequirementsErrorFreeProperty: True");
      return true;
    }
    System.out.println("RequirementsErrorFreeProperty: False");
    return false;
  }

  /*package*/ RequirementsErrorFreeProperty__BehaviorDescriptor() {
    super(REGISTRY);
  }
