...
public class DashboardHintDisplayer_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createContextAssistant_m53z7w_d0(final EditorContext editorContext, final SNode node) {
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setTransformationMenuLookup(new DefaultTransformationMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), MetaAdapterFactory.getConcept(0x102111329b5e427aL, 0x9b371c1f28794a5eL, 0x20fc30679cdcee4aL, "org.iets3.process.dashboard.structure.DashboardHintDisplayer")));
      ...
      public void actionPerformed(ActionEvent p0) {
        ...
        if (selectedOption.equals("Tabular")) {
          ModelAccess.instance().runReadAction(new Runnable() {
            public void run() {
              editorContext.getEditorComponent().getUpdater().setInitialEditorHints(new String[]{"org.iets3.process.dashboard.editor.DashboardVisualisation.TabularView"});
          ...
          ModelAccess.instance().runReadAction(new Runnable() {
            public void run() {
              editorContext.getEditorComponent().getUpdater().setInitialEditorHints(new String[]{"org.iets3.process.dashboard.editor.DashboardVisualisation.DirectedGraph"});
              editorContext.getEditorComponent().update();
                      ...
                      public List<? extends IDiagramElementAccessor> getElements(IAccessorFactory accessorFactory) {
                        ...
                        for (SNode e : Sequence.fromIterable(new Object() {
                          public Iterable<SNode> query() {
                            return SNodeOperations.getNodeDescendants(node, MetaAdapterFactory.getConcept(0x102111329b5e427aL, 0x9b371c1f28794a5eL, 0x3b5f775e0d415b00L, "org.iets3.process.dashboard.structure.FlowData"), false, new SAbstractConcept[]{});
                          }
                        }.query())) {
                        ...
                        for (SNode e : Sequence.fromIterable(new Object() {
                          public Iterable<SNode> query() {
                            return SNodeOperations.getNodeDescendants(node, MetaAdapterFactory.getConcept(0x102111329b5e427aL, 0x9b371c1f28794a5eL, 0x73258383c7270020L, "org.iets3.process.dashboard.structure.StatePointer"), false, new SAbstractConcept[]{});
                          }
                        }.query())) {
                          elements.addAll(accessorFactory.fromSNode(e, false));
                        }
                        for (SNode e : Sequence.fromIterable(new Object() {
                          public Iterable<SNode> query() {
                            return SNodeOperations.getNodeDescendants(node, MetaAdapterFactory.getConcept(0x102111329b5e427aL, 0x9b371c1f28794a5eL, 0x5337259791ac255eL, "org.iets3.process.dashboard.structure.State"), false, new SAbstractConcept[]{});
                          }
                        }.query())) {
                          elements.addAll(accessorFactory.fromSNode(e, false));
                        }
