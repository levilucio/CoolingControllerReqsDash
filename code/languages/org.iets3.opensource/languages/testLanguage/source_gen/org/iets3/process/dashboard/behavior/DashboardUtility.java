package org.iets3.process.dashboard.behavior;
...
import org.iets3.process.modelproperty.behavior.ModelProperty__BehaviorDescriptor;
...
public class DashboardUtility {
  ...
  public DashboardUtility(SModel currentModel) {
    ...
    this.flowData = ListSequence.fromList(SModelOperations.roots(flowModel, MetaAdapterFactory.getConcept(0x102111329b5e427aL, 0x9b371c1f28794a5eL, 0x3b5f775e0d415b00L, "org.iets3.process.dashboard.structure.FlowData"))).first();
  }
  ...
  public boolean isPropertySatisfied(SNode inputNode) {
    ...
    return (boolean) ModelProperty__BehaviorDescriptor.propertyCheck_id5fb3TbDEkMb.invoke(SNodeOperations.cast(modelPropertyNode, MetaAdapterFactory.getConcept(0xecea2a9218f4e3bL, 0xbadca524a5addb7cL, 0x56e0c2409a3be91bL, "org.iets3.process.modelproperty.structure.ModelProperty")), currentModel);
  }
  ...
  public boolean isFormulaSatisfied(SNode propertyFormula) {
    ...
    if (SNodeOperations.isInstanceOf(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x691240ff880dbb0aL, "org.iets3.process.modelproperty.formulae.structure.AtomicProperty"))) {
      boolean result = isPropertySatisfied(SLinkOperations.getTarget(SNodeOperations.cast(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x691240ff880dbb0aL, "org.iets3.process.modelproperty.formulae.structure.AtomicProperty")), MetaAdapterFactory.getReferenceLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x24b2bf7ce180eb54L, 0x24b2bf7ce180eb55L, "conceptDeclaration")));
      return result;
    }

    if (SNodeOperations.isInstanceOf(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334dbL, "org.iets3.process.modelproperty.formulae.structure.AndPropertyFormula"))) {
      System.out.println("AND: " + (isFormulaSatisfied(SLinkOperations.getTarget(SNodeOperations.cast(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334dbL, "org.iets3.process.modelproperty.formulae.structure.AndPropertyFormula")), MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d5L, 0x2745279545540786L, "arg1"))) && isFormulaSatisfied(SLinkOperations.getTarget(SNodeOperations.cast(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334dbL, "org.iets3.process.modelproperty.formulae.structure.AndPropertyFormula")), MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d5L, 0x274527954554078cL, "arg2")))));
      return isFormulaSatisfied(SLinkOperations.getTarget(SNodeOperations.cast(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334dbL, "org.iets3.process.modelproperty.formulae.structure.AndPropertyFormula")), MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d5L, 0x2745279545540786L, "arg1"))) && isFormulaSatisfied(SLinkOperations.getTarget(SNodeOperations.cast(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334dbL, "org.iets3.process.modelproperty.formulae.structure.AndPropertyFormula")), MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d5L, 0x274527954554078cL, "arg2")));
    }

    if (SNodeOperations.isInstanceOf(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334deL, "org.iets3.process.modelproperty.formulae.structure.OrPropertyFormula"))) {
      return isFormulaSatisfied(SLinkOperations.getTarget(SNodeOperations.cast(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334deL, "org.iets3.process.modelproperty.formulae.structure.OrPropertyFormula")), MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d5L, 0x2745279545540786L, "arg1"))) || isFormulaSatisfied(SLinkOperations.getTarget(SNodeOperations.cast(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334deL, "org.iets3.process.modelproperty.formulae.structure.OrPropertyFormula")), MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d5L, 0x274527954554078cL, "arg2")));
    }

    if (SNodeOperations.isInstanceOf(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334e6L, "org.iets3.process.modelproperty.formulae.structure.NotPropertyFormula"))) {
      System.out.println("NOT: " + !(isFormulaSatisfied(SLinkOperations.getTarget(SNodeOperations.cast(propertyFormula, MetaAdapterFactory.getConcept(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334e6L, "org.iets3.process.modelproperty.formulae.structure.NotPropertyFormula")), MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d8L, 0x274527954554078fL, "arg")))));
