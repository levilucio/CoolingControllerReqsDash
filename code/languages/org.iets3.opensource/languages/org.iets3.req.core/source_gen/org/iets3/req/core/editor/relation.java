...
public class relation implements ConceptEditorComponent {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_uxia66_a(editorContext, node);
  }
  private EditorCell createCollection_uxia66_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_uxia66_a");
    editorCell.addEditorCell(this.createRefNode_uxia66_a0(editorContext, node));
    editorCell.addEditorCell(this.createCustomFactory_uxia66_b0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_uxia66_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new relation.kindSingleRoleHandler_uxia66_a0(node, MetaAdapterFactory.getContainmentLink(0xa3c6f64241b744cbL, 0x951b463b8427a245L, 0x5fd70b0af6e37815L, 0x5fd70b0af6e3a4beL, "kind"), editorContext);
    return provider.createCell();
  }
  private class kindSingleRoleHandler_uxia66_a0 extends SingleRoleCellProvider {
  ...
  private EditorCell createCustomFactory_uxia66_b0(final EditorContext editorContext, final SNode node) {


    final EditorCell cell = createRefNodeList_uxia66_a1a(editorContext, node);
  ...
  private EditorCell createRefNodeList_uxia66_a1a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new relation.targetsListHandler_uxia66_a1a(node, "targets", editorContext);
  ...
  private static class targetsListHandler_uxia66_a1a extends RefNodeListHandler {
    public targetsListHandler_uxia66_a1a(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(targetsListHandler_uxia66_a1a.this.getOwner(), MetaAdapterFactory.getContainmentLink(0xa3c6f64241b744cbL, 0x951b463b8427a245L, 0x5fd70b0af6e37815L, 0x5fd70b0af6e38904L, "targets")));
      try {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createCustomFactory_uxia66_a0b0(editorContext, node);
    }
    ...
    private EditorCell createCustomFactory_uxia66_a0b0(final EditorContext editorContext, final SNode node) {


      final EditorCell cell = createConstant_uxia66_a0a1a(editorContext, node);
      EditorCell editorCell = new _FunctionTypes._return_P0_E0<EditorCell>() {
        public EditorCell invoke() {
          cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
            public void execute(EditorContext editorContext) {
    ...
    private EditorCell createConstant_uxia66_a0a1a(EditorContext editorContext, SNode node) {
