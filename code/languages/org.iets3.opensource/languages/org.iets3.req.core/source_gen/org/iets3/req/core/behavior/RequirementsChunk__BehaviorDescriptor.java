...
public final class RequirementsChunk__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(dependencies_id6clJcrJYPM5, allReferenceableContentsInChunk_id6clJcrKmVSn, externallyReferenceableContentsInChunk_id6clJcrKmX4x, addGenericDependecy_id94IdDK$n_l, visibleContentsOfType_id6clJcrJXo2_, getUniquelyNamedElements_id4qSf1u1TRfj);
  ...
  /*package*/ static Iterable<SNode> visibleContentsOfType_id6clJcrJXo2_(@NotNull SNode __thisNode__, SNode targetConcept) {
    return SNodeOperations.ofConcept(SModelOperations.nodesIncludingImported(SNodeOperations.getModel(__thisNode__), null), SNodeOperations.asSConcept(targetConcept));
  }
