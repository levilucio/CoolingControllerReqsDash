...
public class DefaultRequirement_table_tableWithDetails_Editor extends DefaultNodeEditor {
  private Collection<String> myContextHints = Arrays.asList(new String[]{"org.iets3.req.core.editor.requirementsHints.table", "org.iets3.req.core.editor.requirementsHints.tableWithDetails"});
  @Override
  @NotNull
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createPartialTable_1e1faw_a(editorContext, node);
  }
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_1e1faw_a(final EditorContext editorContext, final SNode node) {
  ...
  public Grid createTableCell_1e1faw_a0a0(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell cell = createCollection_1e1faw_a0a0a(editorContext, node);
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        return style;
  ...
  private EditorCell createCollection_1e1faw_a0a0a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_1e1faw_a0a0a");
    editorCell.addEditorCell(this.createReadOnlyModelAccessor_1e1faw_a0a0a0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_1e1faw_b0a0a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createReadOnlyModelAccessor_1e1faw_a0a0a0(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_1e1faw_b0a0a0(EditorContext editorContext, SNode node) {
  ...
  public HeaderGrid createEditorCellHeader_1e1faw_a0a0a(final EditorContext editorContext, final SNode node) {
    ...
    final EditorCell cell = createConstant_1e1faw_a0a0a0(editorContext, node);
    Header header = new EditorCellHeader(new StringHeaderReference("4245955037983817669"), cell);
    header.setStyle(style);
    grid.setElement(0, 0, header);
    return grid;
  }
  private EditorCell createConstant_1e1faw_a0a0a0(EditorContext editorContext, SNode node) {
  ...
  public Grid createTableCell_1e1faw_b0a0(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell cell = createCollection_1e1faw_a1a0a(editorContext, node);
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        return style;
  ...
  private EditorCell createCollection_1e1faw_a1a0a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createVertical(editorContext, node);
    editorCell.setCellId("Collection_1e1faw_a1a0a");
    editorCell.addEditorCell(this.createProperty_1e1faw_a0b0a0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_1e1faw_b0b0a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createProperty_1e1faw_a0b0a0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
  ...
  private EditorCell createRefNode_1e1faw_b0b0a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new DefaultRequirement_table_tableWithDetails_Editor.docSingleRoleHandler_1e1faw_b0b0a0(node, MetaAdapterFactory.getContainmentLink(0xa3c6f64241b744cbL, 0x951b463b8427a245L, 0x477d8ab2bc8195b9L, 0x477d8ab2bc883be0L, "doc"), editorContext);
    return provider.createCell();
  }
  private class docSingleRoleHandler_1e1faw_b0b0a0 extends SingleRoleCellProvider {
  ...
  public HeaderGrid createEditorCellHeader_1e1faw_a1a0a(final EditorContext editorContext, final SNode node) {
    ...
    final EditorCell cell = createConstant_1e1faw_a0b0a0(editorContext, node);
    Header header = new EditorCellHeader(new StringHeaderReference("4245955037983817677"), cell);
    header.setStyle(style);
    grid.setElement(0, 0, header);
    return grid;
  }
  private EditorCell createConstant_1e1faw_a0b0a0(EditorContext editorContext, SNode node) {
  ...
  public Grid createTableCell_1e1faw_c0a0(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell cell = createRefNode_1e1faw_a2a0a(editorContext, node);
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        return style;
  ...
  private EditorCell createRefNode_1e1faw_a2a0a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new DefaultRequirement_table_tableWithDetails_Editor.kindSingleRoleHandler_1e1faw_a2a0a(node, MetaAdapterFactory.getContainmentLink(0xa3c6f64241b744cbL, 0x951b463b8427a245L, 0x477d8ab2bc8195b9L, 0x477d8ab2bc895b1eL, "kind"), editorContext);
    return provider.createCell();
  }
  private class kindSingleRoleHandler_1e1faw_a2a0a extends SingleRoleCellProvider {
  ...
  public HeaderGrid createEditorCellHeader_1e1faw_a2a0a(final EditorContext editorContext, final SNode node) {
    ...
    final EditorCell cell = createConstant_1e1faw_a0c0a0(editorContext, node);
    Header header = new EditorCellHeader(new StringHeaderReference("4245955037983817685"), cell);
    header.setStyle(style);
    grid.setElement(0, 0, header);
    return grid;
  }
  private EditorCell createConstant_1e1faw_a0c0a0(EditorContext editorContext, SNode node) {
  ...
  public Grid createTableCell_1e1faw_d0a0(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell cell = createRefNode_1e1faw_a3a0a(editorContext, node);
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        return style;
  ...
  private EditorCell createRefNode_1e1faw_a3a0a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new DefaultRequirement_table_tableWithDetails_Editor.stateSingleRoleHandler_1e1faw_a3a0a(node, MetaAdapterFactory.getContainmentLink(0xa3c6f64241b744cbL, 0x951b463b8427a245L, 0x477d8ab2bc8195b9L, 0x5463f52ab0dddfbL, "state"), editorContext);
    return provider.createCell();
  }
  private class stateSingleRoleHandler_1e1faw_a3a0a extends SingleRoleCellProvider {
  ...
  public HeaderGrid createEditorCellHeader_1e1faw_a3a0a(final EditorContext editorContext, final SNode node) {
    ...
    final EditorCell cell = createConstant_1e1faw_a0d0a0(editorContext, node);
    Header header = new EditorCellHeader(new StringHeaderReference("4245955037983817693"), cell);
    header.setStyle(style);
    grid.setElement(0, 0, header);
    return grid;
  }
  private EditorCell createConstant_1e1faw_a0d0a0(EditorContext editorContext, SNode node) {
  ...
  public Grid createTableCell_1e1faw_e0a0(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell cell = createRefNodeList_1e1faw_a4a0a(editorContext, node);
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        return style;
  ...
  private EditorCell createRefNodeList_1e1faw_a4a0a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new DefaultRequirement_table_tableWithDetails_Editor.tagsListHandler_1e1faw_a4a0a(node, "tags", editorContext);
  ...
  private static class tagsListHandler_1e1faw_a4a0a extends RefNodeListHandler {
    public tagsListHandler_1e1faw_a4a0a(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(tagsListHandler_1e1faw_a4a0a.this.getOwner(), MetaAdapterFactory.getContainmentLink(0xa3c6f64241b744cbL, 0x951b463b8427a245L, 0x477d8ab2bc8195b9L, 0x477d8ab2bc895b23L, "tags")));
      try {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_1e1faw_a0e0a0(editorContext, node);
    }
    ...
    private EditorCell createConstant_1e1faw_a0e0a0(EditorContext editorContext, SNode node) {
  ...
  public HeaderGrid createEditorCellHeader_1e1faw_a4a0a(final EditorContext editorContext, final SNode node) {
    ...
    final EditorCell cell = createConstant_1e1faw_a0e0a0_0(editorContext, node);
    Header header = new EditorCellHeader(new StringHeaderReference("8479184967783403312"), cell);
    header.setStyle(style);
    grid.setElement(0, 0, header);
    return grid;
  }
  private EditorCell createConstant_1e1faw_a0e0a0_0(EditorContext editorContext, SNode node) {
