...
public class GrammarCellsSubstituteMenu_TermRefTermAttribute extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TermRefTermAttribute() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenu_TermRefTermAttribute.GrammarCellsSubstituteMenuPart_crvbua_a());
    return result;
  }
  private class GrammarCellsSubstituteMenuPart_crvbua_a extends GrammarCellsSubstituteMenuPart {
    @Override
